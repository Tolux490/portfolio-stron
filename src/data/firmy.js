...
export const mechanik = {
  ...
  phone: '+48 512 480 119',
  email: 'warsztat@serwiskolodziej.pl',
...
export const restauracja = {
  ...
  tagline: 'Kuchnia sezonowa. Karta na cztery dania, zmieniana co tydzień.',
  phone: '+48 505 214 760',
  email: 'rezerwacje@ogrodowa3.pl',
...
export const nieruchomosci = {
  ...
  phone: '+48 604 337 902',
  email: 'biuro@kontur-nieruchomosci.pl',
